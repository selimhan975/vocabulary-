      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Организовать событие или мероприятие на определенное время.",
            "zh": "安排某事件或活动在特定时间发生。",
            "es": "Organizar que un evento o actividad suceda en un momento particular.",
            "fr": "Prévoir qu'un événement ou une activité aura lieu à un moment précis.",
            "de": "Vereinbaren, dass ein Ereignis oder eine Aktivität zu einem bestimmten Zeitpunkt stattfindet.",
            "tr": "Bir olayın veya etkinliğin belirli bir zamanda gerçekleşmesini ayarlamak.",
            "ja": "イベントや活動が特定の時間に起こるように手配すること。"
          },
          "examples": [
            {
              "id": "ex491_1",
              "sentence": "We need to schedule a meeting to discuss the new budget priorities.",
              "translation": {
                ...
                "fr": "Nous devons planifier une réunion pour discuter des nouvelles prioridades budgétaires.",
            ...
            {
              "id": "ex491_2",
              "sentence": "My work schedule is incredibly demanding this week.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Отложить событие или мероприятие на более позднее время или дату.",
            "zh": "决定或安排将事件或活动推迟到较晚的时间或日期。",
            "es": "Decidir o arreglar retrasar un evento o actividad hasta una hora o fecha posterior.",
            "fr": "Décider ou s'arranger pour retarder un événement ou une activité à une heure ou une date ultérieure.",
            "de": "Beschließen oder veranlassen, ein Ereignis oder eine Aktivität auf eine spätere Zeit oder ein späteres Datum zu verschieben.",
            "tr": "Bir olayı veya etkinliği daha ileri bir zamana veya tarihe ertelemeye karar vermek veya ayarlamak.",
            "ja": "イベントや活動を後日または後回しにすることを決定または手配すること。"
          },
          "examples": [
            {
              "id": "ex492_1",
              "sentence": "Due to the CEO's absence, we had to put off the presentation until next Monday.",
              "translation": {
            ...
            {
              "id": "ex492_2",
              "sentence": "Don't put off making a decision, as time is running out.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Объем работы, который должен быть выполнен кем-то или чем-то.",
            "zh": "某人或某物要完成的工作量。",
            "es": "La cantidad de trabajo que debe realizar alguien o algo.",
            "fr": "La quantité de travail à accomplir par quelqu'un ou quelque chose.",
            "de": "Die Menge an Arbeit, die von jemandem oder etwas erledigt werden muss.",
            "tr": "Birisi veya bir şey tarafından yapılacak iş miktarı.",
            "ja": "誰かまたは何かが行うべき仕事の量。"
          },
          "examples": [
            {
              "id": "ex493_1",
              "sentence": "The team has been struggling with a heavy workload since three colleagues resigned.",
              "translation": {
            ...
            {
              "id": "ex493_2",
              "sentence": "Managers must ensure that the workload is distributed evenly among staff members.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Оставляющий мало времени или места для гибкости или ошибки.",
            "zh": "留给灵活性或错误的时间或空间很少。",
            "es": "Dejando poco tiempo o espacio para la flexibilidad o el error.",
            "fr": "Laissant peu de temps ou de marge pour la flexibilité ou l'erreur.",
            "de": "Lässt wenig Zeit oder Raum für Flexibilität oder Fehler.",
            "tr": "Esneklik veya hata için çok az zaman veya yer bırakmak.",
            "ja": "柔軟性やエラーのための時間や余地をほとんど残さない。"
          },
          "examples": [
            {
              "id": "ex494_1",
              "sentence": "We are working under a very tight deadline for this project.",
              "translation": {
            ...
            {
              "id": "ex494_2",
              "sentence": "The budget is extremely tight this year, so no extra spending is allowed.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Не успеть сделать что-то достаточно быстро или вовремя.",
            "zh": "未能足够快地或按时做某事。",
            "es": "No hacer algo lo suficientemente rápido o a tiempo.",
            "fr": "Ne pas réussir à faire quelque chose assez rapidement ou à temps.",
            "de": "Etwas nicht schnell genug oder pünktlich tun.",
            "tr": "Bir şeyi yeterince hızlı veya zamanında yapamamak.",
            "ja": "何かを十分に早く、または時間通りに行うことができないこと。"
          },
          "examples": [
            {
              "id": "ex495_1",
              "sentence": "If we fall behind schedule, we might lose our most important client.",
              "translation": {
            ...
            {
              "id": "ex495_2",
              "sentence": "She was ill for two weeks and fell behind in her studies.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Сделать то, на что раньше не было времени.",
            "zh": "做你以前没有时间做的事情。",
            "es": "Hacer algo que no tuviste tiempo de hacer antes.",
            "fr": "Faire quelque chose que vous n'avez pas eu le temps de faire plus tôt.",
            "de": "Etwas tun, wofür Sie früher keine Zeit hatten.",
            "tr": "Daha önce yapmaya vaktiniz olmayan bir şeyi yapmak.",
            "ja": "以前にやる時間がなかったことをやること。"
          },
          "examples": [
            {
              "id": "ex496_1",
              "sentence": "I need to work late tonight to catch up on some urgent emails.",
              "translation": {
            ...
            {
              "id": "ex496_2",
              "sentence": "Let's schedule a meeting next week so we can catch up on your progress.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Решить проблему или трудность.",
            "zh": "解决问题或困难。",
            "es": "Resolver un problema o dificultad.",
            "fr": "Résoudre un problème ou une difficulté.",
            "de": "Ein Problem oder eine Schwierigkeit lösen.",
            "tr": "Bir sorunu veya zorluğu çözmek.",
            "ja": "問題や困難を解決すること。"
          },
          "examples": [
            {
              "id": "ex497_1",
              "sentence": "It took them months to sort out the legal complications of the merger.",
              "translation": {
            ...
            {
              "id": "ex497_2",
              "sentence": "Don't worry about the booking error; I'll sort it out tomorrow morning.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Важное событие в развитии или истории чего-либо.",
            "zh": "某事物发展或历史上的重要事件。",
            "es": "Un evento importante en el desarrollo o la historia de algo.",
            "fr": "Un événement important dans le développement ou l'histoire de quelque chose.",
            "de": "Ein wichtiges Ereignis in der Entwicklung oder Geschichte von etwas.",
            "tr": "Bir şeyin gelişiminde veya tarihinde önemli bir olay.",
            "ja": "何かの発展や歴史における重要な出来事。"
          },
          "examples": [
            {
              "id": "ex498_1",
              "sentence": "Completing the first phase of the software on time is a major milestone for our team.",
              "translation": {
            ...
            {
              "id": "ex498_2",
              "sentence": "The invention of the internet was a significant milestone in human history.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "По сравнению с тем фактом, что; но.",
            "zh": "与...事实相比；但是。",
            "es": "En comparación con el hecho de que; pero.",
            "fr": "Par rapport au fait que ; mais.",
            "de": "Im Vergleich zu der Tatsache, dass; aber.",
            "tr": "O gerçeğiyle karşılaştırıldığında; ama.",
            "ja": "という事実と比較して。しかし。"
          },
          "examples": [
            {
              "id": "ex499_1",
              "sentence": "He prefers to organize meetings in the morning, whereas she prefers the afternoon.",
              "translation": {
            ...
            {
              "id": "ex499_2",
              "sentence": "In the north the climate is cold, whereas in the south it is quite warm.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Способный быть сделанным, выполненным или достигнутым.",
            "zh": "能够制造、完成或实现的。",
            "es": "Capaz de ser hecho, realizado o logrado.",
            "fr": "Capable d'être fait, réalisé ou accompli.",
            "de": "In der Lage, gemacht, getan oder erreicht zu werden.",
            "tr": "Yapılabilir, edilebilir veya başarılabilir.",
            "ja": "作ること、行うこと、または達成することができること。"
          },
          "examples": [
            {
              "id": "ex500_1",
              "sentence": "We need to determine if it is financially feasible to expand into the Asian market.",
              "translation": {
            ...
            {
              "id": "ex500_2",
              "sentence": "Although your idea sounds great, it is simply not feasible given our current tight deadline.",
              "translation": {
