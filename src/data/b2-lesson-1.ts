      ...
      meanings: [
        {
          ...
          translation: { ru: 'способный противостоять или быстро восстанавливаться после трудностей', zh: '能够经受困难情况或从中迅速恢复', es: 'capaz de resistir o recuperarse rápidamente de condiciones difíciles' },
          examples: [
            {
              id: 'w1-m1-e1',
      ...
      meanings: [
        {
          ...
          translation: { ru: 'начать использовать план, систему или закон', zh: '开始使用计划、系统或法律', es: 'empezar a usar un plan, sistema o ley' },
          examples: [
            {
              id: 'w2-m1-e1',
      ...
      meanings: [
        {
          ...
          translation: { ru: 'продолжать иметь; сохранять в существовании', zh: '继续拥有；保持存在', es: 'continuar teniendo; mantener en existencia' },
          examples: [
            {
              id: 'w3-m1-e1',
      ...
      meanings: [
        {
          ...
          translation: { ru: 'чрезвычайно важный или необходимый', zh: '极其重要的或必要的', es: 'extremadamente importante o necesario' },
          examples: [
            {
              id: 'w4-m1-e1',
      ...
      meanings: [
        {
          ...
          translation: { ru: 'развиваться постепенно', zh: '逐渐发展', es: 'desarrollarse gradualmente' },
          examples: [
            {
              id: 'w5-m1-e1',
      ...
      meanings: [
        {
          ...
          translation: { ru: 'происходящий часто или все время', zh: '经常或一直发生的', es: 'que ocurre mucho o todo el tiempo' },
          examples: [
            {
              id: 'w6-m1-e1',
      ...
      meanings: [
        {
          ...
          translation: { ru: 'важный, большой или великий, особенно приводящий к другому результату', zh: '重要的、大量的或巨大的，尤其是导致不同结果的', es: 'importante o notable' },
          examples: [
            {
              id: 'w7-m1-e1',
      ...
      meanings: [
        {
          ...
          translation: { ru: 'получить что-то, особенно прося об этом, покупая или работая ради этого', zh: '获得某物，特别是通过请求、购买或努力工作', es: 'conseguir algo, especialmente pidiéndolo, comprándolo o trabajando por ello' },
          examples: [
            {
              id: 'w8-m1-e1',
      ...
      meanings: [
        {
          ...
          translation: { ru: 'изменять или изменяться, чтобы соответствовать различным условиям', zh: '改变或改变某物，以适应不同的条件或用途', es: 'cambiar, o cambiar algo, para adaptarse a diferentes condiciones o usos' },
          examples: [
            {
              id: 'w9-m1-e1',
      ...
      meanings: [
        {
          ...
          translation: { ru: 'сделать то, что ожидается, на что надеются или что обещано', zh: '做期望、希望或承诺做的事', es: 'hacer algo que se espera, se espera o se promete' },
          examples: [
            {
              id: 'w10-m1-e1',
