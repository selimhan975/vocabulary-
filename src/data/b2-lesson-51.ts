...
export const b2Lesson51: Lesson = {
  ...
  "words": [
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Найти решение проблемы или договориться о чем-то.",
            "zh": "找到问题的解决方案或在某事上达成一致。",
            "es": "Encontrar una solución a un problema o acordar algo.",
            "fr": "Trouver une solution à un problème ou se mettre d'accord sur quelque chose.",
            "de": "Eine Lösung für ein Problem finden oder sich auf etwas einigen.",
            "tr": "Bir soruna çözüm bulmak veya bir konuda anlaşmak.",
            "ja": "問題の解決策を見つける、または何かに合意すること。"
          },
          "examples": [
            {
              "id": "ex501_1",
              "sentence": "The two companies managed to work out a mutually beneficial agreement.",
              "translation": {
            ...
            {
              "id": "ex501_2",
              "sentence": "We still need to work out the exact details of the delivery schedule.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Наконец согласиться на то, чего хочет кто-то, после периода отказов.",
            "zh": "在拒绝了一段时间后，最终同意别人的要求。",
            "es": "Aceptar finalmente lo que alguien quiere, después de negarse por un tiempo.",
            "fr": "Accepter finalement ce que quelqu'un veut, après avoir refusé pendant un certain temps.",
            "de": "Schließlich dem zustimmen, was jemand will, nachdem man sich eine Zeit lang geweigert hat.",
            "tr": "Bir süre reddettikten sonra sonunda birinin istediğini kabul etmek.",
            "ja": "しばらく拒否した後、最終的に誰かの要求に同意すること。"
          },
          "examples": [
            {
              "id": "ex502_1",
              "sentence": "Despite the union's protests, the management refused to give in to their demands.",
              "translation": {
            ...
            {
              "id": "ex502_2",
              "sentence": "In a successful negotiation, neither side should feel like they were forced to give in entirely.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Начать обсуждать тему.",
            "zh": "开始讨论某个话题。",
            "es": "Empezar a discutir un tema.",
            "fr": "Commencer à discuter d'un sujet.",
            "de": "Anfangen, ein Thema zu diskutieren.",
            "tr": "Bir konuyu tartışmaya başlamak.",
            "ja": "話題について議論し始めること。"
          },
          "examples": [
            {
              "id": "ex503_1",
              "sentence": "I didn't want to bring up the issue of the budget, but it is unavoidable.",
              "translation": {
            ...
            {
              "id": "ex503_2",
              "sentence": "She brings up a very valid point regarding customer satisfaction.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Несмотря на то, что только что было сказано или сделано.",
            "zh": "尽管刚才说了或做了什么。",
            "es": "A pesar de lo que se acaba de decir o hacer.",
            "fr": "Malgré ce qui vient d'être dit ou fait.",
            "de": "Trotz dem, was gerade gesagt oder getan wurde.",
            "tr": "Az önce söylenenlere veya yapılanlara rağmen.",
            "ja": "今言われたことやされたことにもかかわらず。"
          },
          "examples": [
            {
              "id": "ex504_1",
              "sentence": "The proposal has a few flaws; nevertheless, we believe it has great potential.",
              "translation": {
            ...
            {
              "id": "ex504_2",
              "sentence": "We were deeply disappointed by the delay. Nevertheless, we are committed to finishing the project.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Акт выражения или чувства оппозиции или неприязни к чему-либо или кому-либо.",
            "zh": "表达或感觉对某事或某人的反对或厌恶的行为。",
            "es": "El acto de expresar o sentir oposición o disgusto por algo o alguien.",
            "fr": "Le fait d'exprimer ou de ressentir une opposition ou une aversion pour quelque chose ou quelqu'un.",
            "de": "Der Akt, Opposition oder Abneigung gegen etwas oder jemanden auszudrücken oder zu empfinden.",
            "tr": "Bir şeye veya birine karşı çıkma veya sevmemeyi ifade etme veya hissetme eylemi.",
            "ja": "何かや誰かに対して反対や嫌悪を表現したり感じたりする行為。"
          },
          "examples": [
            {
              "id": "ex505_1",
              "sentence": "Does anyone have any strong objections to the new company policy?",
              "translation": {
            ...
            {
              "id": "ex505_2",
              "sentence": "She raised a valid objection regarding the safety of the equipment.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "То, что вы соглашаетесь сделать или дать кому-то, чтобы положить конец спору.",
            "zh": "你同意做或给某人的事，为了结束争论。",
            "es": "Algo que aceptas hacer o dar a alguien, para terminar una discusión.",
            "fr": "Quelque chose que vous acceptez de faire ou de donner à quelqu'un, afin de mettre fin à une dispute.",
            "de": "Etwas, das Sie zustimmen zu tun oder jemandem zu geben, um einen Streit zu beenden.",
            "tr": "Bir tartışmayı bitirmek için yapmayı veya birine vermeyi kabul ettiğiniz bir şey.",
            "ja": "議論を終わらせるために、あなたが行うことや誰かに与えることに同意すること。"
          },
          "examples": [
            {
              "id": "ex506_1",
              "sentence": "To reach an agreement, both sides will have to make some concessions.",
              "translation": {
            ...
            {
              "id": "ex506_2",
              "sentence": "The government refused to offer any concessions to the striking workers.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Не определенный или не согласованный, или сказанный или сделанный осторожно, но неуверенно.",
            "zh": "不确定或未达成一致的，或者以小心但不确定的方式说或做的。",
            "es": "No seguro o acordado, o dicho o hecho de una manera cuidadosa pero incierta.",
            "fr": "Pas certain ou convenu, ou dit ou fait d'une manière prudente mais incertaine.",
            "de": "Nicht sicher oder vereinbart, oder auf vorsichtige, aber unsichere Weise gesagt oder getan.",
            "tr": "Kesin veya kararlaştırılmış değil, ya da dikkatli ama belirsiz bir şekilde söylenen veya yapılan.",
            "ja": "確実ではない、または合意されていない、あるいは慎重だが不確かな方法で言われたり行われたりすること。"
          },
          "examples": [
            {
              "id": "ex507_1",
              "sentence": "We have reached a tentative agreement, but the final details are yet to be confirmed.",
              "translation": {
            ...
            {
              "id": "ex507_2",
              "sentence": "He made a tentative suggestion about changing the deadline.",
              "translation": {
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Способный работать по назначению или способный добиться успеха.",
            "zh": "能够按预期运作或能够成功。",
            "es": "Capaz de funcionar según lo previsto o capaz de tener éxito.",
            "fr": "Capable de fonctionner comme prévu ou capable de réussir.",
            "de": "In der Lage, wie beabsichtigt zu funktionieren oder erfolgreich zu sein.",
            "tr": "Amaçlandığı gibi çalışabilen veya başarılı olabilen.",
            "ja": "意図したとおりに機能する、または成功することができる。"
          },
          "examples": [
            {
              "id": "ex508_1",
              "sentence": "We must find a commercially viable solution to this problem.",
              "translation": {
            ...
            {
              "id": "ex508_2",
              "sentence": "Without funding, the project is no longer viable.",
              "translation": {
    ...
    },
    {
      ...
      "level": "B2",
      "translations": {
        "ru": "рычаг давления / использовать",
        "zh": "影响力 / 利用",
        "es": "ventaja / aprovechar",
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Сила влиять на людей и получать желаемые результаты, или использовать что-то с максимальной выгодой.",
            "zh": "影响人们并获得所需结果的能力，或最大程度地利用某事物的能力。",
            "es": "Poder para influir en las personas y obtener los resultados que deseas, o usar algo para obtener la máxima ventaja.",
            "fr": "Pouvoir d'influencer les gens et d'obtenir les résultats souhaités, ou d'utiliser quelque chose à son avantage maximum.",
            "de": "Macht, Menschen zu beeinflussen und die gewünschten Ergebnisse zu erzielen, oder etwas zum maximalen Vorteil zu nutzen.",
            "tr": "İnsanları etkileme ve istediğiniz sonuçları alma veya bir şeyi maksimum avantaj için kullanma gücü.",
            "ja": "人々に影響を与え、望む結果を得る力、または何かを最大限に活用すること。"
          },
          "examples": [
            {
              "id": "ex509_1",
              "sentence": "The union used the upcoming deadline as leverage during the negotiations.",
              "translation": {
            ...
            {
              "id": "ex509_2",
              "sentence": "We need to leverage our existing technology to enter the new market.",
              "translation": {
                "ru": "Нам нужно использовать нашу существующую технологию, чтобы выйти на новый рынок.",
                "zh": "我们需要利用现有的技术进入新市场。",
      ...
      "meanings": [
        {
          ...
          "translation": {
            "ru": "Таким образом, который подходит или правилен для ситуации.",
            "zh": "以适合或适合情况的方式。",
            "es": "De una manera que es adecuada o correcta para la situación.",
            "fr": "D'une manière appropriée ou juste pour la situation.",
            "de": "In einer Weise, die für die Situation angemessen oder richtig ist.",
            "tr": "Duruma uygun veya doğru bir şekilde.",
            "ja": "状況に適切または正しい方法で。"
          },
          "examples": [
            {
              "id": "ex510_1",
              "sentence": "The budget has been reduced, so we must adjust our plans accordingly.",
              "translation": {
            ...
            {
              "id": "ex510_2",
              "sentence": "Please read the new safety regulations and act accordingly.",
              "translation": {
                "ru": "Пожалуйста, прочитайте новые правила техники безопасности и действуйте должным образом.",
                "zh": "请阅读新的安全规定并采取相应行动。",
                "es": "Por favor, lea las nuevas regulaciones de seguridad y actúe en consecuencia.",
                ...
                "tr": "Lütfen yeni güvenlik düzenlemelerini okuyun ve buna göre hareket edin.",
